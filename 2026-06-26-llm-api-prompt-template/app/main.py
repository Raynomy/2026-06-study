...
from app.services import chat_with_llm, chat_with_llm_stream, chat_with_template
...
@app.post("/chat/template", response_model=TemplateChatResponse)
def chat_template(request: TemplateChatRequest):
