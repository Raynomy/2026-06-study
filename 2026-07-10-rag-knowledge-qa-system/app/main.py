...
from app.rag_service import answer_with_context, answer_with_context_stream
...
@app.post("/documents/answer/stream")
def answer_document_stream(request: DocumentAnswerRequest):
